...
HoodHierarchy = {ToontownCentral: (SillyStreet, LoopyLane, PunchlinePlace),
 ...
 FunnyFarm: (SillyStreet, LoopyLane, PunchlinePlace),
...
MinigamePlayerMatrix = {
    1: (CannonGameId, MazeGameId, RingGameId, VineGameId),
...
BugReportSite = 'https://poodletoothiland.tk'
