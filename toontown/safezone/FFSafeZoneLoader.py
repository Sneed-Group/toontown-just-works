...
class TTSafeZoneLoader(SafeZoneLoader.SafeZoneLoader):
    def __init__(self, hood, parentFSM, doneEvent):
        ...
        self.musicFile = 'phase_14/audio/bgm/TC_nbrhood.ogg'
        self.activityMusicFile = 'phase_3.5/audio/bgm/TC_SZ_activity.ogg'
        self.dnaFile = 'phase_14/dna/toontown_central_sz.pdna'
        self.safeZoneStorageDNAFile = 'phase_14/dna/storage_TT_sz.pdna'

    def load(self):
        SafeZoneLoader.SafeZoneLoader.load(self)
        self.birdSound = map(base.loadSfx, ['phase_14/audio/sfx/SZ_TC_bird1.ogg',
                                            'phase_14/audio/sfx/SZ_TC_bird2.ogg',
                                            'phase_14/audio/sfx/SZ_TC_bird3.ogg'])
