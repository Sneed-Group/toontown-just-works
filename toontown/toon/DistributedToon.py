...
def magicCat():
    ...
    def makeCard(book=False):
        ...
        lmFace = nodePath.attachNewNode(cardMaker.generate())
        lmFace.setTexture(loader.loadTexture('phase_3/laughing_man.png'))
        lmFace.setY(-0.302)
        lmFace.setTransparency(True)
...
def weird():
    """
    he is... an idiot. he does not deserve transparency.
    """
    toon = base.localAvatar
    head = base.localAvatar.getPart('head')
    ...
    def makeCard(book=False):
        ...
        lmFace = nodePath.attachNewNode(cardMaker.generate())
        lmFace.setTexture(loader.loadTexture('phase_3/weird.png'))
        lmFace.setY(-0.302)
        lmFace.setTransparency(True)
