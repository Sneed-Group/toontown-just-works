...
NPCToonDict = {
 ...
 20001: (-1, lnames[3308], ('mss', 'ss', 'm', 'm', 3, 0, 3, 3, 1, 11, 1, 11, 1, 0), 'm', 0, NPC_BLOCKER),
...
if config.GetBool('want-new-toonhall', 1):
    NPCToonDict[2001] = (2513, lnames[3308], ('mss', 'ss', 'm', 'm', 3, 0, 3, 3, 1, 11, 1, 11, 1, 0), 'm', 0, NPC_FLIPPYTOONHALL)
else:
    NPCToonDict[2001] = (2513, lnames[3308], ('mss', 'ss', 'm', 'm', 3, 0, 3, 3, 1, 11, 1, 11, 1, 0), 'm', 0, NPC_REGULAR)
